...
const DEFAULT_SETTINGS: LabelSettings = {
  ...
  label_template: {
    labelWidthMm: 34,
    labelHeightMm: 25,
    productName: { visible: true, xMm: 1, yMm: 1, widthMm: 32, heightMm: 4.5, fontSizePx: 7, bold: true, align: 'center' },
    supplier: { visible: true, xMm: 1, yMm: 5.5, widthMm: 32, heightMm: 2.5, fontSizePx: 6, bold: false, align: 'center' },
    encryptedPrice: { visible: true, xMm: 1, yMm: 8, widthMm: 32, heightMm: 3, fontSizePx: 7, bold: true, align: 'center', letterSpacingPx: 0.4 },
    barcode: { visible: true, xMm: 2, yMm: 11, widthMm: 30, heightMm: 12, quietZoneMm: 1, type: 'CODE128', showText: true },
    barcodeNumber: { visible: true, xMm: 1, yMm: 23, widthMm: 32, heightMm: 2, fontSizePx: 6, align: 'center', letterSpacingPx: 0.2 },
    normalPrice: { visible: false, xMm: 1, yMm: 8, widthMm: 32, heightMm: 3, fontSizePx: 7, bold: true, align: 'center' },
